...
impl PulseState {
    ...
    pub fn outcome_counts(&self) -> (usize, usize, usize, usize) {
        ...
        for o in &self.outcomes {
            match o.outcome {
                crate::outcome::Outcome::Success => success += 1,
                crate::outcome::Outcome::Partial => partial += 1,
                crate::outcome::Outcome::Failed => failed += 1,
                crate::outcome::Outcome::Surprising => surprising += 1,
            }
        }
...
mod tests {
    use super::*;
    use crate::outcome::{Outcome, TaskType};
    use chrono::Utc;
